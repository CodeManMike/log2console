...
namespace SampleAppendersApp.Appender
{
	...
	/// NOTE: System.Messaging is not available in .NET 8, so this appender is disabled for .NET 8+
	/// </remarks>
#if NET_FRAMEWORK
	...
	public class MsmqAppender : log4net.Appender.AppenderSkeleton
	{
		...
		public log4net.Layout.PatternLayout LabelLayout { get; set; }

		protected override void Append(LoggingEvent loggingEvent)
		{
			// System.Messaging is not available in .NET 8+
			ErrorHandler.Error("MSMQ functionality is not available in .NET 8+. Please use alternative logging mechanisms.");
		}
	}
#endif
}
